-- tp
CREATE TABLE tp (
    tp_id SERIAL PRIMARY KEY, tp_name VARCHAR(50) NOT NULL
);
-- notebook
CREATE TABLE notebook (
    notebook_id SERIAL PRIMARY KEY, tp_id INT REFERENCES tp (tp_id), notebook_name VARCHAR(100) NOT NULL
);
